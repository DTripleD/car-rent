import{h as on,r as h,E as an,c as un,s as sn,R as ie,n as y,a as vt,j as p,P as A,b as ln,u as bt,d as cn,e as dn,_ as C,f as pn,g as xt,i as ce,k as w,S as Et,l as fn}from"./index-4bd9eb5f.js";import{H as hn}from"./main-car-e21e7ec8.js";var S=function(e,r){var i=arguments;if(r==null||!on.call(r,"css"))return h.createElement.apply(void 0,i);var t=i.length,a=new Array(t);a[0]=an,a[1]=un(e,r);for(var s=2;s<t;s++)a[s]=i[s];return h.createElement.apply(null,a)};function Be(){for(var n=arguments.length,e=new Array(n),r=0;r<n;r++)e[r]=arguments[r];return sn(e)}var mn=function(){var e=Be.apply(void 0,arguments),r="animation-"+e.name;return{name:r,styles:"@keyframes "+r+"{"+e.styles+"}",anim:1,toString:function(){return"_EMO_"+this.name+"_"+this.styles+"_EMO_"}}};function gn(n,e){if(n==null)return{};var r={},i=Object.keys(n),t,a;for(a=0;a<i.length;a++)t=i[a],!(e.indexOf(t)>=0)&&(r[t]=n[t]);return r}var Ct={color:void 0,size:void 0,className:void 0,style:void 0,attr:void 0},Ge=ie.createContext&&ie.createContext(Ct),ee=globalThis&&globalThis.__assign||function(){return ee=Object.assign||function(n){for(var e,r=1,i=arguments.length;r<i;r++){e=arguments[r];for(var t in e)Object.prototype.hasOwnProperty.call(e,t)&&(n[t]=e[t])}return n},ee.apply(this,arguments)},vn=globalThis&&globalThis.__rest||function(n,e){var r={};for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&e.indexOf(i)<0&&(r[i]=n[i]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var t=0,i=Object.getOwnPropertySymbols(n);t<i.length;t++)e.indexOf(i[t])<0&&Object.prototype.propertyIsEnumerable.call(n,i[t])&&(r[i[t]]=n[i[t]]);return r};function yt(n){return n&&n.map(function(e,r){return ie.createElement(e.tag,ee({key:r},e.attr),yt(e.child))})}function je(n){return function(e){return ie.createElement(bn,ee({attr:ee({},n.attr)},e),yt(n.child))}}function bn(n){var e=function(r){var i=n.attr,t=n.size,a=n.title,s=vn(n,["attr","size","title"]),o=t||r.size||"1em",u;return r.className&&(u=r.className),n.className&&(u=(u?u+" ":"")+n.className),ie.createElement("svg",ee({stroke:"currentColor",fill:"currentColor",strokeWidth:"0"},r.attr,i,s,{className:u,style:ee(ee({color:n.color||r.color},r.style),n.style),height:o,width:o,xmlns:"http://www.w3.org/2000/svg"}),a&&ie.createElement("title",null,a),n.children)};return Ge!==void 0?ie.createElement(Ge.Consumer,null,function(r){return e(r)}):e(Ct)}function xn(n){return je({tag:"svg",attr:{viewBox:"0 0 24 24"},child:[{tag:"path",attr:{fill:"none",d:"M0 0h24v24H0z"}},{tag:"path",attr:{d:"M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"}}]})(n)}const En=y.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100vw;
...
`,$n=document.querySelector("#root"),Ke=n=>{n?document.body.style.overflow="hidden":document.body.style.overflow="auto"},Hn=({onClose:n,model:e,make:r,id:i,img:t,year:a,address:s,rentalPrice:o,type:u,functionalities:l,fuelConsumption:c,engineSize:d,description:v,accessories:x,rentalConditions:b,mileage:g})=>{h.useEffect(()=>{Ke(!0);const E=I=>{I.code==="Escape"&&n()};return window.addEventListener("keydown",E),()=>{Ke(!1),window.removeEventListener("keydown",E)}},[n]);const f=E=>{E.currentTarget===E.target&&n()},m=s.split(", "),D=m[1],M=m[2],F=b.split(`
`,3),O=F[0].match(/\d+/),P=parseInt(O[0],10);return vt.createPortal(p.jsx(En,{onClick:f,className:"show",children:p.jsx(Cn,{className:"show",children:p.jsxs(Fn,{children:[p.jsx(yn,{type:"button","aria-label":"close button",onClick:n,children:p.jsx(Sn,{})}),p.jsx(wn,{src:t,alt:r}),p.jsxs(On,{children:[p.jsx(Mn,{children:p.jsxs(In,{children:[p.jsx(Ye,{children:r}),p.jsxs(Dn,{children:[e,p.jsx("span",{style:{color:"black"},children:","})]}),p.jsx(Ye,{children:a})]})}),p.jsxs(An,{children:[p.jsx(ne,{children:D}),p.jsx(ne,{children:M}),p.jsxs(ne,{children:["id: ",i]}),p.jsxs(ne,{children:["Year: ",a]}),p.jsxs(ne,{children:["Type: ",u]}),p.jsxs(ne,{children:["Fuel Consumption: ",c]}),p.jsxs(ne,{children:["Engine Size: ",d]})]}),p.jsx(Pn,{children:v}),p.jsxs(Vn,{children:[p.jsx(Ln,{children:"Accessories and functionalities:"}),p.jsxs(Rn,{children:[x.map((E,I)=>p.jsx(qe,{children:E},I)),l.map((E,I)=>p.jsx(qe,{children:E},I))]})]}),p.jsxs(kn,{children:[p.jsx(Tn,{children:"Rental Conditions:"}),p.jsxs(Bn,{children:[p.jsxs(ue,{children:["Minimum age: ",p.jsx("span",{children:P})]}),p.jsx(ue,{children:F[1]}),p.jsx(ue,{children:F[2]}),p.jsxs(ue,{children:["Mileage: ",p.jsx("span",{children:g.toLocaleString("en-EN")})]}),p.jsxs(ue,{children:["Price: ",p.jsx("span",{children:o})]})]})]}),p.jsx(jn,{href:"tel:+380730000000",children:"Rental car"})]})]})})}),$n)};function _n(n){return je({tag:"svg",attr:{viewBox:"0 0 20 20",fill:"currentColor","aria-hidden":"true"},child:[{tag:"path",attr:{fillRule:"evenodd",d:"M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z",clipRule:"evenodd"}}]})(n)}function zn(n){return je({tag:"svg",attr:{fill:"none",viewBox:"0 0 24 24",strokeWidth:"2",stroke:"currentColor","aria-hidden":"true"},child:[{tag:"path",attr:{strokeLinecap:"round",strokeLinejoin:"round",d:"M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"}}]})(n)}const Nn=y.li`
  width: 274px;
...
`,Qt=y(Uo)`
  ...
  .select__menu-list::-webkit-scrollbar-thumb {
    background: ${n=>n.theme.colors.grey};
    border-radius: 14px;
  }
`,Yo=y(Qt)`
  width: 224px;
...
`,ra=y.div`
  ...
  flex-direction: column;
  align-items: center;
`,en=({errorMessage:n})=>p.jsx(Et,{children:p.jsxs(ra,{children:[p.jsx("h2",{children:n}),p.jsx(na,{src:hn,alt:"car-img"})]})});en.propTypes={errorMessage:A.string};const gt=8,ia=({cars:n,fav:e})=>{const[r,i]=h.useState(""),[t,a]=h.useState(""),[s,o]=h.useState(""),[u,l]=h.useState(""),[c,d]=h.useState(1),[v,x]=h.useState([]),b=bt(nr);h.useEffect(()=>{x(n)},[n]);const g=30,f=500,D=ta(f,10).filter(E=>E>=g).map(E=>({label:E,value:E})),M=()=>{i(""),a(""),o(""),l(""),x(n)},F=()=>{d(1);const E=L=>/^[a-zA-Z\s]+$/i.test(L);let I=n;if(r!==""){if(!E(r)){alert("Car brand should contain only EN letters !");return}I=I.filter(({make:L})=>L.toLowerCase()===r.toLowerCase())}if(t!==""){if(Number(t)<g){alert(`Price cannot be less than ${g}!`);return}else if(Number(t)>f){alert(`Price cannot be greater than ${f}!`);return}I=I.filter(({rentalPrice:L})=>Number(L.substr(1))<=Number(t)).sort((L,T)=>L.rentalPrice-T.rentalPrice)}if(s===""&&u!==""&&(I=I.filter(({mileage:L})=>L<=u)),s!==""&&u===""&&(I=I.filter(({mileage:L})=>L>=s)),s>u&&u!==""){alert("Mileage is incorrect!");return}if(s!==""&&u!==""){const L=parseInt(s,10),T=parseInt(u,10);if(!Number.isInteger(L)||!Number.isInteger(T)){alert("Mileage must be an integer without decimals, in the range from 1000 to 6620!");return}if(L<1e3||T>6620){alert("Mileage should be in the range of 1000 to 6620!");return}I=I.filter(({mileage:k})=>k>=s&&k<=u)}return I.sort((L,T)=>{const k=Number(L.rentalPrice.substr(1)),_=Number(T.rentalPrice.substr(1));return k===_?L.mileage-T.mileage:k-_}),x(I),(r!==""||t!==""||s!==""||u!=="")&&v.length===0&&alert("No cars matching your criteria found."),I},V=v.slice(0,c*gt),O=()=>d(c+1),P=Math.ceil(v.length/gt);return p.jsx(p.Fragment,{children:b?p.jsx(fn,{}):p.jsx(p.Fragment,{children:v.length>0?p.jsxs(Et,{children:[p.jsxs(Go,{children:[p.jsxs(Pe,{children:[p.jsx(Ae,{children:"Car brand"}),p.jsx(Yo,{placeholder:"Enter the text",options:ea,onChange:E=>i(E.value),classNamePrefix:"select",value:r===""?"":{value:r,label:r}})]}),p.jsxs(Pe,{children:[p.jsx(Ae,{children:"Price/ 1 hour"}),p.jsx(qo,{placeholder:"To $",options:D,onChange:E=>a(E.value),classNamePrefix:"select",value:t===""?"":{value:t,label:`To ${t}$`}})]}),p.jsxs(Pe,{children:[p.jsx(Ae,{children:"Сar mileage / km"}),p.jsxs(Ko,{children:[p.jsx(Xo,{type:"text",placeholder:"From",onChange:E=>o(E.target.value)}),p.jsx(Zo,{type:"text",placeholder:"To",onChange:E=>l(E.target.value)})]})]}),p.jsx(mt,{type:"button",onClick:F,children:"Search"}),p.jsx(mt,{type:"button",onClick:M,children:"Clear"})]}),p.jsx(Wo,{children:V.map(E=>p.jsx(St,{fav:e,car:E},E.id))}),P!==c&&p.jsx(Jo,{onClick:O,type:"button",children:"Load more"})," "]}):p.jsx(en,{errorMessage:"No cars available"})})})};ia.propTypes={cars:A.arrayOf(A.shape({make:A.string,model:A.string,mileage:A.number,rentalConditions:A.string,accessories:A.array,engineSize:A.string,id:A.number,description:A.string,rentalPrice:A.string,fuelConsumption:A.string,functionalities:A.array,year:A.number,img:A.string,type:A.string,rentalCompany:A.string,address:A.string})),fav:A.bool};export{ia as C,ua as a,tr as g};
